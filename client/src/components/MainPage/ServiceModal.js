...
function ServiceModal({serviceModalHandler}){
  return (
    <div className={style.container}>
      <div className={style.containerbg} onClick={serviceModalHandler}/>
      <div className={style.modalbox}>
        {/* 로고 박스 */}
        <div className={style.logobox}>
        <Link to='/mainpage'><div id ={style.logo} /></Link>
          <div className={style.logotitle}>이용 약관 동의 <strong>[필수]</strong></div>
        </div>

        {/* 텍스트 박스 */}
        <div className={style.textbox}>
          <textarea readOnly className={style.textarea} defaultValue="제1장 총칙 제1조(목적) 
        ...
        <div className={style.buttonbox}>
          <div className={style.loginbutton} onClick={serviceModalHandler}>뒤 로 가 기</div>
        </div>
      </div>
    </div>
  )
